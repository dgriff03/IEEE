...
\author{
	\IEEEauthorblockN{
		Brett Fischler\IEEEauthorrefmark{1}, 
		Daniel Griffin\IEEEauthorrefmark{1}, 
		Tyler Lubeck\IEEEauthorrefmark{1}, 
		Kenneth Hunter Wapman\IEEEauthorrefmark{1}, 
		Mai Vu\IEEEauthorrefmark{2}
	}
	...
	\IEEEauthorblockA{
		Brett.Fischler@gmail.com, 
		\{Daniel.Griffin, Hunter.Wapman\}@tufts.edu,
		Tyler@TylerLubeck.com,
		MaiVu@ece.tufts.edu
	}
}
...
\hline
 \pbox{20cm}{\vspace{1 mm}Penalty-Weighted \\ Euclidean distance\vspace{1 mm}} 	& 2.87   & 2.10\\
\hline
\pbox{20cm}{\vspace{1 mm}Linear Combination of \\$\sigma_{E'}$ and $\sigma_{J^{-1}}$ ($\sigma_{E' + J^{-1}}$)\vspace{1 mm}}  	& 2.78   & 1.76\\
\hline
...
\bibitem{Liu} H, Liu, H. Darabi, P. Banerjee, and J. Liu,
...
\bibitem{Chaudhuri} S. Saha, K. Chaudhuri, D. Sanghi, and P. Bhagwat,
...
\bibitem{Sayad}  A. H. Sayed, A. Tarighat, and N. Khajehnouri,
...
\bibitem{Sayad2} Tsung-Nan Lin and Po-Chiang Lin,
...
\bibitem{Bahl2} P. Bahl, V. N. Padmanabhan and A. Balachandran,
